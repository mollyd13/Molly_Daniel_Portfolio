...
public class GameManager : MonoBehaviour
{
    ...
    public void gameOver(){
        isGameOver = true;
        LeanTween.scale(gameOverScreen, new Vector3(1.5f, 1.5f, 1.5f), 2f).setEase(LeanTweenType.easeOutElastic);
    }
    ...
    public void youWin(){
        LeanTween.scale(youWinScreen, new Vector3(1, 1, 1), 2f).setEase(LeanTweenType.easeOutElastic);
        isGameOver = true;
    }
}
